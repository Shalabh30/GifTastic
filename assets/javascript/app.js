...
// my array
var topic = ["Cat", "Dog", "Zebra", "Rhino", "Parrot", "rabbit"];
...
function displayGifs() {
	...
	var queryURL = "https://api.giphy.com/v1/gifs/search?q=" + animal + "&api_key=dc6zaTOxFJmzC&limit=8";
...
//list of already created animals
displayGifButtons();
addNewButton();
removeLastButton();
